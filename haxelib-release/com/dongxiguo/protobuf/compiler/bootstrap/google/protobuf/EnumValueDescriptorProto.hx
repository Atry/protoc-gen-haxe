...
typedef EnumValueDescriptorProto = {
	...
	@:optional public var options(default,null):StdTypes.Null<com.dongxiguo.protobuf.compiler.bootstrap.google.protobuf.EnumValueOptions>;
}
...
class FileOptions_Merger {
	static var FIELD_MAP(default,never):com.dongxiguo.protobuf.binaryFormat.ReadUtils.FieldMap<com.dongxiguo.protobuf.compiler.bootstrap.google.protobuf.FileOptions_Builder>={
		var fieldMap=new com.dongxiguo.protobuf.binaryFormat.ReadUtils.FieldMap<com.dongxiguo.protobuf.compiler.bootstrap.google.protobuf.FileOptions_Builder>();
		{
			...
			fieldMap.set(72,function (builder:com.dongxiguo.protobuf.compiler.bootstrap.google.protobuf.FileOptions_Builder,input:com.dongxiguo.protobuf.binaryFormat.ILimitableInput) builder.optimizeFor=com.dongxiguo.protobuf.compiler.bootstrap.google.protobuf.fileOptions.OptimizeMode_EnumClass.valueOf(com.dongxiguo.protobuf.binaryFormat.ReadUtils.readInt32(input)));
